        ...
        <Grid container>
          <PrimaryRow item container justifyContent='space-between' alignItems='center'>
            <PaddingGrid
              ...
              <Link href='https://dndmtl.com/' target='_blank' rel='noopener noreferrer'>
            ...
            <UserAvatarColumn item container xs={12} md={3}>
              ...
              <Grid
                ...
                xs
                md={4}
                justifyContent={window.innerWidth > 768 ? 'end' : 'center'}
          ...
          <SecondaryRow
            ...
            <PaddingGrid item xs={12} md={2}>
              <InertiaLink
                className={route().current()?.includes('campgaign') ? 'active' : ''}
                color='white'
                href='/#'>
                Campaigns
              </InertiaLink>
