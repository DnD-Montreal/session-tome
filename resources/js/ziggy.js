const Ziggy = {
    ...
    routes: {
        ...
        'trade.update': {uri: 'trade/{trade}', methods: ['PUT', 'PATCH'], bindings: {trade: 'id'}},
        'trade.destroy': {uri: 'trade/{trade}', methods: ['DELETE'], bindings: {trade: 'id'}},
        'trade.show': {uri: 'trade/{trade}', methods: ['GET', 'HEAD'], bindings: {trade: 'id'}},
        ...
        'user.edit': {uri: 'user/{user}/edit', methods: ['GET', 'HEAD'], bindings: {user: 'id'}},
        'user.update': {uri: 'user/{user}', methods: ['PUT', 'PATCH'], bindings: {user: 'id'}},
